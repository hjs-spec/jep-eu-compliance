...
**JEP Industry Identifier**: `https://jep-eu-compliance mapping.org/industry/hr`
...
{
  "ext": {
    "https://jep-eu-compliance mapping.org/industry/hr": {
...
| `human_final_decision` | boolean | Must be true for Annex III compliance mapping | Yes |
